...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      frameSrc: ["'self'", 'https://challenges.cloudflare.com', 'https://checkout.razorpay.com', 'https://api.razorpay.com', 'https://*.razorpay.com', 'https://razorpay.com'],
      objectSrc: ["'none'"],
      baseUri: ["'self'"],
      formAction: ["'self'", 'https://checkout.razorpay.com', 'https://api.razorpay.com', 'https://*.razorpay.com', 'https://razorpay.com'],
      frameAncestors: ["'none'"],
      workerSrc: ["'self'", "blob:"],
      manifestSrc: ["'self'"],
