...
export async function syncVersionOnPublish(version) {
    ...
    try {
        ...
        // NOTE: We do NOT update package-lock.json manually as it contains integrity hashes 
        // that must be generated by npm. 'npm install' after this script will sync the lockfiles.
