                ...
                {showDeleteConfirm && (
                  <div className="mt-4 p-4 bg-red-500/10 border border-red-500/30 rounded-xl space-y-4 animate-fade-in">
                    <div className="flex items-start gap-2 text-red-400 text-sm">
                      ...
                      <p>
                        This will <strong>permanently remove ALL subscription data</strong>{' '}
                        including the LemonSqueezy link. The user will be reset to Free tier and the
                        Sync button will no longer work. This action is{' '}
                        <strong>logged for audit</strong>.
                      </p>
                    </div>
