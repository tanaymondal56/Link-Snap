  ...
  return (
    <div className="space-y-6">
      ...
      {showSuccessModal && (
        ...
        >
          <div
            className="bg-gray-900 border border-white/10 rounded-2xl p-8 max-w-md relative shadow-2xl"
      ...
      {showConfirmModal && validationData && (
        ...
        >
          <div
            className="bg-gradient-to-br from-gray-800 to-gray-900 border border-white/10 rounded-2xl p-6 max-w-md w-full relative shadow-2xl overflow-hidden"
            onClick={(e) => e.stopPropagation()}
          >
                ...
                <div className="bg-gray-950/30 rounded-lg p-4 text-sm space-y-2 border border-white/5">
                  <div className="flex justify-between">
                    ...
                    <span className="text-white font-medium capitalize">
                      {validationData.duration.replace('_', ' ')}
                    </span>
                  </div>
                  <div className="flex justify-between">
      ...
      >
        ...
        <div className="relative z-10 flex flex-col md:flex-row justify-between items-start md:items-center mb-4 sm:mb-8 border-b border-white/5 pb-4 sm:pb-6 gap-4 sm:gap-6">
          <div>
            <h3
              className="text-xs font-bold uppercase tracking-[0.2em] mb-2 opacity-80"
          ...
          <div
            className="p-3 sm:p-4 rounded-2xl backdrop-blur-md border shadow-2xl"
            style={{ backgroundColor: 'var(--stat-icon-bg)', borderColor: 'var(--glass-border)' }}
          >
            <CreditCard
              size={24}
              className="sm:hidden"
        ...
        <div className="relative z-10 flex flex-col md:flex-row gap-4 sm:gap-8 justify-between items-end">
          <div className="flex-1 w-full">
            ...
            <p
              className="text-sm md:text-base opacity-80 mb-4 sm:mb-8 max-w-xl leading-relaxed"
              style={{ color: 'var(--subtext-color)' }}
            >
              {profile?.subscription?.tier === 'free'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-4 sm:mt-6">
        {/* Links Created */}
        <div
          className="rounded-2xl p-4 sm:p-6 transition-colors duration-300 relative overflow-hidden group"
            ...
            return (
              <div className="relative z-10">
                <div className="flex justify-between text-base mb-3 items-end">
                  ...
                  <span className="font-medium mb-1" style={{ color: 'var(--subtext-color)' }}>
                    / {tier === 'business' ? '∞' : limit.toLocaleString()} max
                  </span>
                </div>
                <div
      ...
      {/* Redeem Code Section */}
      <div
        className="rounded-2xl p-4 sm:p-6 mt-4 sm:mt-6 transition-colors duration-300 relative overflow-hidden group"
        style={{ backgroundColor: 'var(--glass-bg)', border: '1px solid var(--glass-border)' }}
      >
        <h4
          className="font-semibold text-lg flex items-center gap-3 mb-4 sm:mb-5"
          style={{ color: 'var(--heading-color)' }}
        >
        ...
        <form
          ...
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 relative z-10 w-full max-w-2xl"
        >
          <input
            type="text"
            value={redeemCode}
            ...
            className="flex-1 rounded-xl px-4 sm:px-5 py-3 sm:py-4 font-mono text-base transition-all focus:outline-none"
            style={{
