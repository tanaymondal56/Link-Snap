export const TIERS = {
  ...
  pro: { features: ['custom_alias', 'link_expiration', 'password_protection', 'custom_datetime', 'custom_qr', 'api_access', 'geo_analytics', 'utm_builder', 'bio_page', 'advanced_analytics'] },
  business: { features: ['custom_alias', 'link_expiration', 'password_protection', 'custom_datetime', 'custom_qr', 'api_access', 'geo_analytics', 'utm_builder', 'bio_page', 'ab_testing', 'device_redirects', 'team', 'webhooks', 'custom_domains', 'advanced_analytics'] }
};
