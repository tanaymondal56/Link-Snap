...
export const getShortUrl = (shortId) => {
    ...
    // In production: ALWAYS use the frontend domain (current browser origin).
    // This ensures short URLs point to the CF Pages frontend, avoiding the hidden backend URL.
    if (isProduction) {
