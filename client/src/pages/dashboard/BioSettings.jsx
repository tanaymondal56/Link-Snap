...
const SOCIAL_FIELDS = [
  { id: 'twitter', label: 'Twitter/X', icon: AtSign, placeholder: 'username' },
  { id: 'instagram', label: 'Instagram', icon: AtSign, placeholder: 'username' },
  { id: 'tiktok', label: 'TikTok', icon: TikTokIcon, placeholder: '@handle' },
  { id: 'linkedin', label: 'LinkedIn', icon: AtSign, placeholder: 'username' },
  { id: 'youtube', label: 'YouTube', icon: AtSign, placeholder: '@handle' },
  { id: 'github', label: 'GitHub', icon: AtSign, placeholder: 'username' },
