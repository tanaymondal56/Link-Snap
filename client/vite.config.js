  ...
  return {
    ...
    server: {
      ...
      headers: {
        ...
        'Permissions-Policy': 'camera=(), microphone=(), geolocation=(), run-ad-auction=(), join-ad-interest-group=(), browsing-topics=(), publickey-credentials-get=(self), payment=(self "https://checkout.razorpay.com" "https://api.razorpay.com" "https://*.razorpay.com" "https://razorpay.com"), clipboard-write=(self), clipboard-read=(self), fullscreen=(self)',
        'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' https://static.cloudflareinsights.com https://ajax.cloudflare.com https://challenges.cloudflare.com https://checkout.razorpay.com https://api.razorpay.com https://cdn.razorpay.com https://*.razorpay.com https://razorpay.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com data:; img-src 'self' data: blob: https:; frame-src 'self' https://challenges.cloudflare.com https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://razorpay.com; connect-src 'self' http://localhost:5000 ws://localhost:5000 ws://localhost:3000 https://api.lksnp.qzz.io wss://api.lksnp.qzz.io https://lksnp.qzz.io https://beta.lksnp.qzz.io wss://beta.lksnp.qzz.io https://api-beta.lksnp.qzz.io wss://api-beta.lksnp.qzz.io https://cloudflareinsights.com https://static.cloudflareinsights.com https://challenges.cloudflare.com https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://razorpay.com; base-uri 'self'; form-action 'self' https://checkout.razorpay.com https://api.razorpay.com https://*.razorpay.com https://razorpay.com; frame-ancestors 'none'; object-src 'none'; worker-src 'self' blob:; manifest-src 'self';"
      },
      proxy: {
        '/api': {
